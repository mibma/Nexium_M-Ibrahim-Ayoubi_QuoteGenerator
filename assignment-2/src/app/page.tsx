...
export default function Home() {
  ...
  return (
    <div className="max-w-6xl mx-auto py-10 px-6 main-container">
      <div className="grid grid-cols-2 grid-rows-2 gap-6">

        {/* Top Left: Input Box */}
        <div className="border p-4 rounded bg-white shadow card h-64 overflow-auto">
        ...
        <div className="border p-4 rounded bg-gray-100 shadow card h-64 overflow-auto">
        ...
        <div className="border p-4 rounded bg-gray-50 shadow card h-64 overflow-auto">
